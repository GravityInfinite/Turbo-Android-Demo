...
import cn.gravity.android.GravityEngineTrackViewOnClick;
import cn.gravity.android.ScreenAutoTracker;

public class ClickTestActivity extends AppCompatActivity implements ScreenAutoTracker {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        GravityEngineHelper.enableAutoTrack();
    ...
    public String getScreenUrl() {
        return "gravityengine://page/click";
    }
